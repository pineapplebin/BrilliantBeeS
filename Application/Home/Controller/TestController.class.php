...
//        $forgery->add_field('plate_desc', 'text', 10);
        $forgery->add_field('plate_name', 'name');
        $forgery->add_field('plate_desc', 'title');
        $forgery->add_field('plate_create_time', 'designated', strtotime('now'));
    ...
    public function newtest() {
        ...
        $result = $relation->join('RIGHT JOIN bbs_plate ON bbs_user_plate_relation.plate_id=bbs_plate.plate_id')->select();
